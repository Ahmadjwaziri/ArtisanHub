        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link"><i class="fa fa-user-edit me-2"></i>Manage-Admin</a>  
                    <a href="#" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Staffs</a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Performance</a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-user-edit me-2"></i>Manage-Users</a>
